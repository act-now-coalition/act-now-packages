 ...
 *
 * If the child element already has a `width` property, it will
 * be overwritten by the passed-down width. The child element
 * will only be rendered once the parent has a width greater than 0,
 * in order to prevent from rendering the component too early.
 */
